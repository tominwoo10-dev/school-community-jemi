...
- 학사일정: 2026학년도 확정 학사일정 실데이터 반영 + API 연동 가능 구조 (ACADEMIC_API_URL만 채우면 됨)
...
// ------------------------------------------------------------
// 📅 학사일정 (2026학년도 확정 학사일정 실데이터, API 연동 가능 구조)
// ------------------------------------------------------------

// 확정 2026년 학사일정(배부용) PDF 기준 실제 데이터
// 추후 학교 학사일정 API 연동 시 이 배열을 API 응답으로 교체하면 됩니다.
const scheduleData = [
  { date: "2026-03-02", title: "대체공휴일" },
  { date: "2026-03-03", title: "74회 입학식" },
  { date: "2026-03-17", title: "학교학급설명회(1학년)" },
  { date: "2026-03-18", title: "학교학급설명회(2학년)" },
  { date: "2026-03-19", title: "학교학급설명회(3학년)" },
  { date: "2026-03-20", title: "재경동문초청 서울탐방(1박2일)" },
  { date: "2026-03-24", title: "전국연합학력평가(1,2,3학년)" },
  { date: "2026-04-02", title: "진로체험(1,2,3학년)" },
  { date: "2026-04-03", title: "진로체험(1,2,3학년)" },
  { date: "2026-04-07", title: "1학년 영어듣기평가" },
  { date: "2026-04-08", title: "2학년 영어듣기평가" },
  { date: "2026-04-09", title: "3학년 영어듣기평가" },
  { date: "2026-04-27", title: "1학기 중간고사" },
  { date: "2026-04-28", title: "1학기 중간고사" },
  { date: "2026-04-29", title: "1학기 중간고사" },
  { date: "2026-04-30", title: "1학기 중간고사" },
  { date: "2026-05-01", title: "노동절" },
  { date: "2026-05-04", title: "체육한마당" },
  { date: "2026-05-05", title: "어린이날" },
  { date: "2026-05-07", title: "전국연합학력평가(3학년)" },
  { date: "2026-05-21", title: "교육과정 및 대입설명회(학부모)" },
  { date: "2026-05-25", title: "대체공휴일" },
  { date: "2026-06-03", title: "전국동시지방선거일" },
  { date: "2026-06-04", title: "전국연합학력평가(1,2학년)/모의평가(3학년)" },
  { date: "2026-06-15", title: "학생자치선거 공고" },
  { date: "2026-07-01", title: "1학기 기말고사" },
  { date: "2026-07-02", title: "1학기 기말고사" },
  { date: "2026-07-03", title: "1학기 기말고사" },
  { date: "2026-07-08", title: "전국연합학력평가(3학년)" },
  { date: "2026-07-09", title: "학교자율교육과정" },
  { date: "2026-07-10", title: "학생자치선거 / 학교자율교육과정" },
  { date: "2026-07-13", title: "학교자율교육과정" },
  { date: "2026-07-14", title: "학교자율교육과정" },
  { date: "2026-07-16", title: "문화예술체험" },
  { date: "2026-07-17", title: "제헌절" },
  { date: "2026-07-20", title: "여름방학식" },
  { date: "2026-08-17", title: "대체공휴일" },
  { date: "2026-08-18", title: "2학기 개학식" },
  { date: "2026-09-02", title: "전국연합학력평가(1,2학년)/모의평가(3학년)" },
  { date: "2026-09-08", title: "1학년 영어듣기평가" },
  { date: "2026-09-09", title: "2학년 영어듣기평가" },
  { date: "2026-09-10", title: "3학년 영어듣기평가" },
  { date: "2026-09-24", title: "추석연휴" },
  { date: "2026-09-25", title: "추석연휴" },
  { date: "2026-10-02", title: "73주년 개교기념식" },
  { date: "2026-10-05", title: "대체공휴일" },
  { date: "2026-10-06", title: "재량휴업일(개교기념일)" },
  { date: "2026-10-09", title: "한글날" },
  { date: "2026-10-12", title: "2학기 중간고사" },
  { date: "2026-10-13", title: "2학기 중간고사" },
  { date: "2026-10-14", title: "2학기 중간고사" },
  { date: "2026-10-15", title: "2학기 중간고사" },
  { date: "2026-10-20", title: "전국연합학력평가(1,2,3학년)" },
  { date: "2026-11-03", title: "수학여행(2학년)" },
  { date: "2026-11-04", title: "수학여행(2학년)" },
  { date: "2026-11-05", title: "수학여행(2학년)/현장체험학습(1학년)" },
  { date: "2026-11-06", title: "수학여행(2학년)/현장체험학습(1학년)" },
  { date: "2026-11-18", title: "대학수학능력시험 예비소집" },
  { date: "2026-11-19", title: "대학수학능력시험(1,2학년 재량휴업)" },
  { date: "2026-11-20", title: "중학생학부모초청 고교진학설명회" },
  { date: "2026-12-14", title: "2학기 기말고사" },
  { date: "2026-12-15", title: "2학기 기말고사" },
  { date: "2026-12-16", title: "2학기 기말고사" },
  { date: "2026-12-17", title: "2학기 기말고사" },
  { date: "2026-12-22", title: "학교자율교육과정" },
  { date: "2026-12-24", title: "학교자율교육과정" },
  { date: "2026-12-25", title: "성탄절" },
  { date: "2026-12-29", title: "동아리축제한마당" },
  { date: "2026-12-30", title: "겨울방학식/문화예술체험" },
  { date: "2027-01-01", title: "신정" },
  { date: "2027-02-01", title: "2월 개학식" },
  { date: "2027-02-05", title: "72회 졸업식/종업식" },
  { date: "2027-02-08", title: "설연휴" },
  { date: "2027-02-09", title: "대체공휴일" },
  { date: "2027-02-10", title: "새학년준비 집중운영기간" },
  { date: "2027-02-11", title: "새학년준비 집중운영기간" },
  { date: "2027-02-12", title: "새학년준비 집중운영기간" }
];
...
async function fetchAcademicEvents() {
  if (!ACADEMIC_API_URL) return scheduleData;
  try {
    const res = await fetch(ACADEMIC_API_URL);
    if (!res.ok) throw new Error("API 응답 오류");
    return await res.json();
  } catch (err) {
    toast("학사일정 API 연동에 실패하여 기본 데이터를 표시합니다.");
    return scheduleData;
  }
}
